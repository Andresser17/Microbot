...
import net.runelite.client.plugins.microbot.blackjack.enums.Location;
import net.runelite.client.plugins.microbot.blackjack.enums.PlayerState;
...
import static net.runelite.client.plugins.microbot.blackjack.enums.PlayerState.*;
...
//                            }
    ...
    private void walkToDesiredLocation(BlackJackConfig config) {
        switch (playerState) {
            case BANKING:
                // Go to nearest bank
                WorldPoint nearestBank = BankLocation.NARDAH.getWorldPoint();
                Rs2Walker.walkTo(nearestBank, 8);
                sleepUntilFulfillCondition(() -> Rs2Player.getWorldLocation() == nearestBank, () -> Rs2Random.wait(800, 1200));
                break;
        }
    }
    ...
    private void getPlayerState(BlackJackConfig config) {
//        if (isReadyToProcess(config)) {
//            playerState = net.runelite.client.plugins.microbot.plankmaker.enums.PlayerState.PROCESSING;
//            return;
//        }
//
//        if (isReadyToBank(config)) {
//            playerState = net.runelite.client.plugins.microbot.plankmaker.enums.PlayerState.BANKING;
//            return;
//        }
//
//        playerState =  net.runelite.client.plugins.microbot.plankmaker.enums.PlayerState.IDLE;
    }
